...
class BUiSkirmishBuildWallAction(uiGameContext: BUiGameContext, private val producable: BProducable) :
    ...
    inner class UiClickMode(uiGameContext: BUiGameContext) : BUiAction.UiClickMode(uiGameContext, this) {
        ...
        private val producable = this@BUiSkirmishBuildWallAction.producable
