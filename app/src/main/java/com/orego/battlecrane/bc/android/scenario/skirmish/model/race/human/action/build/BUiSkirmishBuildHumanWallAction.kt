...
class BUiSkirmishBuildHumanWallAction(uiGameContext: BUiGameContext, private val uiUnit: BUiUnit) :
    ...
    companion object {
        ...
        const val ACTION_NAME = "Build a wall"
    }
    ...
    open class Informer {
        ...
        companion object {
            ...
            const val CHARACTERISTICS = "Vertically build two blocks nearly your buildings"

            const val DESCRIPTION = "Wall defends your units"
        }
