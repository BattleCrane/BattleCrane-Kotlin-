package com.orego.battlecrane.bc.api.model.adjutant.trigger
...
@BAdjutantComponent
open class BUnitOnCreateTrigger protected constructor(context: BGameContext, var playerId: Long) :
    BNode(context) {
    ...
    companion object {
        ...
        fun connect(context: BGameContext, create: () -> BUnitOnCreateTrigger) {
