...
class BSkirmishHumanGeneratorHolderOnProduceEnableTrigger private constructor(
    ...
    val holder: BHumanGeneratorHolder
    ...
    override fun handle(event: BEvent): BEvent? {
        if (event is BOnProduceEnablePipe.Event && event.producableId == this.holder.item.producableId) {
            println("BSkirmishHumanGeneratorHolderOnProduceEnableTrigger ${this.holder.item}!")
    ...
    private inner class UpgradeBuildingClickMode : BClickMode {
        ...
        private val uiPipe =
            this@BSkirmishHumanGeneratorHolderOnProduceEnableTrigger.uiGameContext.uiPipe
