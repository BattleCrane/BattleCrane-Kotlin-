...
class BUiHumanFactory private constructor(uiGameContext: BUiGameContext, override val unit: BHumanFactory) :
    ...
    abstract class Informer(protected val factory: BHumanFactory) {

        protected open val characteristicsText: String
            get() {
                val factory = this.factory
                val currentHitPoints = factory.currentHitPoints
                val maxHitPoints = factory.maxHitPoints
                val currentLevel = factory.currentLevel
                val maxLevel = factory.maxLevel
                return "Building\n" +
                        "Size: 3x2\n" +
