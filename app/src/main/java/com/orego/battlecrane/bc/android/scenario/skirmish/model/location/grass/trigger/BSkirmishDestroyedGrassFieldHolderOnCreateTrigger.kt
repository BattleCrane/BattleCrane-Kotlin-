...
class BSkirmishDestroyedGrassFieldHolderOnCreateTrigger private constructor(
    ...
    companion object {
        ...
        fun connect(uiGameContext: BUiGameContext) {
            ...
            val uiTrigger = BSkirmishDestroyedGrassFieldHolderOnCreateTrigger(uiGameContext)
