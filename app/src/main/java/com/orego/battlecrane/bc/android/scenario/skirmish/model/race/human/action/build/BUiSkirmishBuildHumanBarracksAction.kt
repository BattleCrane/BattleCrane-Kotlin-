...
class BUiSkirmishBuildHumanBarracksAction(uiGameContext: BUiGameContext, private val uiUnit: BUiUnit) :
    ...
    companion object {
        ...
        const val ACTION_NAME = "Build a barracks"
    }
...
//        this.uiUnit.dismiss(uiGameContext)
    ...
    open class Informer {
        ...
        companion object {
            ...
            const val CHARACTERISTICS = "Build a barracks nearly your buildings"

            const val DESCRIPTION = "Train marines in a barracks"
        }
