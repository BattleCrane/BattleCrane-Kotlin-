...
@BAdjutantComponent
class BSkirmishHumanGeneratorOnCreateTrigger private constructor(context: BGameContext, var playerId: Long) :
    BNode(context) {

    companion object {

        fun connect(context: BGameContext, playerId: Long) {
            val pipe = BSkirmishHumanGeneratorOnCreateTrigger(
                context,
                playerId
            ).intoPipe()
    ...
    inner class Pipe : BPipe(this.context, mutableListOf(this)) {
        ...
        val playerId = this@BSkirmishHumanGeneratorOnCreateTrigger.playerId
    }
}
