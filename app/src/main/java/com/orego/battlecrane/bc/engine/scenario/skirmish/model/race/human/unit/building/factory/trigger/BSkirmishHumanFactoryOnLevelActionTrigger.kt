...
class BSkirmishHumanFactoryOnLevelActionTrigger private constructor(
    ...
    override var levelable: BHumanFactory
    ...
    inner class Pipe : BPipe(this.context, mutableListOf(this)) {
        ...
        var levelable = this@BSkirmishHumanFactoryOnLevelActionTrigger.levelable

        override fun isFinished() = this@BSkirmishHumanFactoryOnLevelActionTrigger.isFinished()
    }
