...
class BUiHumanHeadquarters private constructor(
    ...
    companion object {
        ...
        const val UNIT_NAME = "Headquarters"
    }
    ...
    abstract class Informer(protected val headquarters: BHumanHeadquarters) {

        protected open val characteristicsText: String
            get() {
                val headquarters = this.headquarters
                val currentHitPoints = headquarters.currentHitPoints
                val maxHitPoints = headquarters.maxHitPoints
                return "Building\n" +
                        "Size: 2x2\n" +
