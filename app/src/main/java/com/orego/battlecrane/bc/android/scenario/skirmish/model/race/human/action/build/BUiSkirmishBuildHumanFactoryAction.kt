...
class BUiSkirmishBuildHumanFactoryAction(uiGameContext: BUiGameContext, private val uiUnit: BUiUnit) :
    ...
    companion object {
        ...
        const val ACTION_NAME = "Build a factory"
    }
    ...
    override fun canActivate(uiGameContext: BUiGameContext): Boolean {
        ...
        return this.producable.isProduceEnable && comparison > 0
    }
        ...
        override fun onNextClickMode(nextUiClickMode: BUiClickMode?): BUiClickMode? {
            if (nextUiClickMode is BUiUnit.UiClickMode) {
                ...
                if (clickedUnit is BEmptyField) {
                    ...
                    val x = clickedUnit.x
                    val y = clickedUnit.y
                    val event = BSkirmishHumanConstructFactoryEvent(producableId, x, y)
    ...
    open class Informer {
        ...
        companion object {
            ...
            const val CHARACTERISTICS = "Build a factory nearly your buildings"

            const val DESCRIPTION = "Produce tanks in a factory"
        }
