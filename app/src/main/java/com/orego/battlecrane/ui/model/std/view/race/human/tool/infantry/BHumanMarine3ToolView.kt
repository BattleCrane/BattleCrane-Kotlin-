...
class BHumanMarine3ToolView(measuredCellSize: Int, context: Context) :
    BToolView(
    ...
    companion object {
        ...
        private const val UNIT_NAME = "Marine 3"
    ...
    class Builder : BViewRender.ViewBuilder<Class<out BUnit>, BToolView> {
        ...
        override fun build(value: Class<out BUnit>, measuredCellSize: Int, context: Context) =
            BHumanMarine3ToolView(measuredCellSize, context)

        override val type: String = BHumanMarine.Marine3::class.java.name
    }
}