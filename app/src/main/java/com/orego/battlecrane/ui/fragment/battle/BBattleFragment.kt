...
class BBattleFragment : BFragment() {
    ...
    inner class Presenter : BFragment.BPresenter() {
        ...
        inner class BUiGameContext(val gameContext: BGameContext) {
            ...
            val mapSurface by lazy {
                ConstraintModel(this@BBattleFragment.fragment_battle_map_constraint_layout)
            }

            val buildToolsSurface by lazy {
                ConstraintModel(this@BBattleFragment.fragment_battle_build_actions)
            }

            val trainToolsSurface by lazy {
                ConstraintModel(this@BBattleFragment.fragment_battle_train_actions)
            }
